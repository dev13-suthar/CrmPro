...
const ColumnContainer = ({col,tasks,handleDeleteTask}:{col:Columns,tasks:additonalType[],handleDeleteTask:(id?: number) => Promise<void>}) => {
  ...
  return (
    <div ref={setNodeRef} {...attributes} {...listeners}  style={style} className='flex flex-col bg-secondary px-4 py-2 rounded-md w-full  h-[300px] md:h-[490px]  overflow-y-auto gap-2'>
